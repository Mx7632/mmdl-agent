...
- ������ݣ�
  - �� conversation_summary �� conversation_compacted_turns �� context �����ֶ�����Ϊ DetectionState / TaskRuntimeState ����ʽ�ֶΡ�
  - nswer_node �� eport ·����Ϊ���ȶ�ȡ runtime view �еĻỰժҪ������Ĭ�ϴ� context ȡֵ��
  - state_rehydration.restore_state() ���Ӽ���Ǩ�ƣ��� checkpoint ��ֻ������ context[conversation_summary]���ָ�ʱ���Զ�ӳ�䵽���ֶΡ�
  - pp/memory/conversation.py �������� context shadow ��������ݵ�ǰ API payload ��ǰ�˶�ȡ·����
- Ӱ�췶Χ��
  - pp/memory/state.py
  - pp/memory/conversation.py
  - pp/core/answer_node.py
